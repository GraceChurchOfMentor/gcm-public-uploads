...
var uploader = new qq.s3.FineUploader({
    ...
    validation: {
        allowedExtensions: ['mp4', 'mov', 'avi', 'mpg', 'mpeg', 'm4v', 'wmv', 'webm', 'mkv', 'flv', 'vob', 'ogg', 'ogv', '3gp']
    },
    deleteFile: {
        enabled: false,
        endpoint: "/s3"
...
var __WEBPACK_AMD_DEFINE_RESULT__;// Fine Uploader 5.16.0 - MIT licensed. http://fineuploader.com
(function(global) {
